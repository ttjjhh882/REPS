error id: _empty_/RenewableEnergyAnalyzer.EnergyData#value.
file:///C:/Users/16593/hello-world/src/main/scala/Main.scala
empty definition using pc, found symbol in pc: 
found definition using semanticdb; symbol _empty_/RenewableEnergyAnalyzer.EnergyData#value.
...
========================""".stripMargin)
  ...
  while (true) {
    ...
    DATASETS.get(input) match {
      case Some(dataset) => return dataset
      case None => println("无效选择，请重新输入。")
    }
  }
  // 不会执行到这里
  (0, "")
